...
namespace cAlgo.Robots
{
    ...
    public class ADXDEMAscreener : Robot
    {
        ...
        [Parameter("Telegram Bot Key", DefaultValue = "1645443313:AAECYf0uSTj7aWk-QFfizQHurtGkFImE0Tk")]
        public string BOT_API_KEY { get; set; }
        //
        //1282406359:AAGzi9N3s2xSdswfHdn4gH1qnzv6niPsB8k
        //1282406359:AAGzi9N3s2xSdswfHdn4gH1qnzv6niPsB8k
        ...
        protected override void OnStart()
        {
            ...
            SendMessageToAllChannels("The ADX 2 EMA bot is running on " + SymbolName + " in " + Chart.TimeFrame + " timeframe");
        ...
        protected bool IsPosOpen()
        {
            ...
            var MyPositions = Positions.FindAll("ADXEMA", SymbolName);
