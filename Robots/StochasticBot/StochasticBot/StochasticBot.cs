...
namespace cAlgo.Robots
{
    ...
    public class StochasticBot : Robot
    {
        ...
        {
            if (stochasticOscillator.PercentK.Last(2) < stochasticOscillator.PercentD.Last(2) && StateBot != 1)
            {
            ...
            if (stochasticOscillator.PercentK.Last(2) > stochasticOscillator.PercentD.Last(2) && StateBot != 2)
            {
                if (stochasticOscillator.PercentK.LastValue < stochasticOscillator.PercentD.LastValue)
                {
