...
namespace cAlgo.Robots
{
    ...
    public class hendrixmscbot5 : Robot
    {
        ...
        private bool CheckTime()
        {
            ...
            var stopTime = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, StopHour, StopMinute, 0);
