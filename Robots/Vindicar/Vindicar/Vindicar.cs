...
namespace cAlgo
{
    ...
    public class Vindicar : Robot
    {
        ...
        protected override void OnBar()
        {
            ...
            {
                if (positionsBuy != null && ichimoku60.TenkanSen.HasCrossedBelow(ichimoku60.KijunSen, 1))
                {
                    ClosePosition(position);
                }
                else if (positionsSell != null && ichimoku60.TenkanSen.HasCrossedAbove(ichimoku60.KijunSen, 1))
                {
                    ClosePosition(position);
                }
            }
