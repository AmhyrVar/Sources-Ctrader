...
namespace cAlgo
{
    ...
    public class Minitron : Robot
    {
        ...
        [Parameter("Switch Close PSSA", DefaultValue = true)]
        public bool swc_PSSA { get; set; }
        [Parameter("Switch Entry PSSB", DefaultValue = true)]
        public bool swe_PSSB { get; set; }

        [Parameter("Switch Close PSSB", DefaultValue = true)]
        public bool swc_PSSB { get; set; }
        [Parameter("Switch Entry PK", DefaultValue = true)]
        public bool swe_PK { get; set; }

        [Parameter("Switch Close PK", DefaultValue = true)]
        public bool swc_PK { get; set; }
        [Parameter("Switch Entry PT", DefaultValue = true)]
        public bool swe_PT { get; set; }

        [Parameter("Switch Close PT", DefaultValue = true)]
        public bool swc_PT { get; set; }
        [Parameter("Switch Entry KSSB", DefaultValue = true)]
        public bool swe_KSSB { get; set; }

        [Parameter("Switch Close KSSB", DefaultValue = true)]
        public bool swc_KSSB { get; set; }
        [Parameter("Switch Entry KSSA", DefaultValue = true)]
        public bool swe_KSSA { get; set; }

        [Parameter("Switch Close KSSA", DefaultValue = true)]
        public bool swc_KSSA { get; set; }

        [Parameter("Switch Entry TSSB", DefaultValue = true)]
        public bool swe_TSSB { get; set; }

        [Parameter("Switch Close TSSB", DefaultValue = true)]
        public bool swc_TSSB { get; set; }

        [Parameter("Switch Entry TSSA", DefaultValue = true)]
        public bool swe_TSSA { get; set; }

        [Parameter("Switch Close TSSA", DefaultValue = true)]
        public bool swc_TSSA { get; set; }

        [Parameter("Switch Entry TK", DefaultValue = true)]
        public bool swe_TK { get; set; }

        [Parameter("Switch Close TK", DefaultValue = true)]
        public bool swc_TK { get; set; }
...
foreach (var position in Positions)
            ...
            while (PT = true && PK = true && PSSB= true && PSSA= true && KSSB= true && KSSA= true && TSSB= true && TSSA= true && TK && positionsBuy != null)
            {
