...
namespace cAlgo.Robots
{
    ...
    public class Hedgebotv4testversion : Robot
    {
        ...
        private void PositionsOnOpened(PositionOpenedEventArgs args)
        {
            ...
            if (args.Position.TradeType == TradeType.Buy && args.Position.Label == ToHedgeLabel)
            {
                ...
                var HEP = args.Position.EntryPrice - (0.1 * DP);
                Print(args.Position.EntryPrice + "Is OG entry price and " + DP + "Pips later is Hedge entry price at " + HEP);
        ...
        protected override void OnBar()
        {
            ...
            {
                ExecuteMarketOrder(TradeType.Buy, SymbolName, 2, "myPos", 10000, 2000);
            }
