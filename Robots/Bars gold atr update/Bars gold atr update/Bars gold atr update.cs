...
namespace cAlgo.Robots
{
    ...
    public class Barsgoldatrupdate : Robot
    {
        ...
        {
            if ((Bars.ClosePrices.Last(1) > ichimoku.SenkouSpanA.Last(26) && Bars.ClosePrices.Last(1) < ichimoku.SenkouSpanB.Last(26)) || (Bars.ClosePrices.Last(1) < ichimoku.SenkouSpanA.Last(26) && Bars.ClosePrices.Last(1) > ichimoku.SenkouSpanB.Last(26)))
            {
                ichimokusignal = true;
            }
            if ((Bars.OpenPrices.Last(1) > ichimoku.SenkouSpanA.Last(26) && Bars.OpenPrices.Last(1) < ichimoku.SenkouSpanB.Last(26)) || (Bars.OpenPrices.Last(1) < ichimoku.SenkouSpanA.Last(26) && Bars.OpenPrices.Last(1) > ichimoku.SenkouSpanB.Last(26)))
            {
                ichimokusignal = true;
            }
            ...
            if (ichimokusignal && Bars.ClosePrices.Last(1) > ichimoku.SenkouSpanA.Last(26) && Bars.ClosePrices.Last(1) > ichimoku.SenkouSpanB.Last(26) && Bars.OpenPrices.Last(1) > ichimoku.SenkouSpanA.Last(26) && Bars.OpenPrices.Last(1) > ichimoku.SenkouSpanB.Last(26) && Bars.ClosePrices.Last(1) > Bars.OpenPrices.Last(26) && Bars.HighPrices.Last(1) > Bars.HighPrices.Last(2) && Bars.LowPrices.Last(1) > Bars.LowPrices.Last(2))
            {
            ...
            if (ichimokusignal && Bars.ClosePrices.Last(1) > ichimoku.SenkouSpanA.Last(26) && Bars.ClosePrices.Last(1) > ichimoku.SenkouSpanB.Last(26) && Bars.OpenPrices.Last(1) > ichimoku.SenkouSpanA.Last(26) && Bars.OpenPrices.Last(1) > ichimoku.SenkouSpanB.Last(26) && Bars.ClosePrices.Last(1) > Bars.OpenPrices.Last(1) && Bars.HighPrices.Last(1) < Bars.HighPrices.Last(2) && Bars.LowPrices.Last(1) < Bars.LowPrices.Last(2))
            {
            ...
            if (ichimokusignal && Bars.ClosePrices.Last(1) < ichimoku.SenkouSpanA.Last(1) && Bars.ClosePrices.Last(1) < ichimoku.SenkouSpanB.Last(1) && Bars.OpenPrices.Last(1) < ichimoku.SenkouSpanA.Last(26) && Bars.OpenPrices.Last(1) < ichimoku.SenkouSpanB.Last(26) && Bars.ClosePrices.Last(1) < Bars.OpenPrices.Last(1) && Bars.HighPrices.Last(1) > Bars.HighPrices.Last(2) && Bars.LowPrices.Last(1) > Bars.LowPrices.Last(2))
            {
