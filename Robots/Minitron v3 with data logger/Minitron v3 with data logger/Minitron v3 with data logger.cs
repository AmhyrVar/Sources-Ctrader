...
namespace cAlgo
{
    ...
    public class Minitronv3withdatalogger : Robot
    {
        ...
        public int PerceptronBuyOpen { get; set; }
        [Parameter(DefaultValue = 0)]
        public int PerceptronBuyClose { get; set; }
