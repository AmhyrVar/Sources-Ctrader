...
namespace cAlgo.Robots
{
    ...
    public class CrazysumlasttodateOnBar2 : Robot
    {
        ...
        AllowTrade = true;
            ...
            if (_sma1.Result.LastValue == _ema1.Result.LastValue && Po.Length > 0 && _sma1.Result.LastValue != cross &&_ema1.Result.LastValue != cross1)    
            {
            ...
            if (Po.Length != 0 && (_sma1.Result.HasCrossedAbove(_ema1.Result,0) || _sma1.Result.HasCrossedBelow(_ema1.Result,0)) && _sma1.Result.LastValue != cross &&_ema1.Result.LastValue != cross1 )
            {
                foreach (var po in Po)
                {
                    ClosePosition(po);
